...
public class CreatePlayerMoveService implements AfterCreateMoveService {
    ...
    public void process(DominoGame game, CreateGameMove createGameMove) {
        DominoGameMove move = createGameMove.toCreateGameMove(game);
        dominoGameMoveRepository.save(move);
    }
}
